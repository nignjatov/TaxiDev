...
.btn a {
    background-image: url(https://i3.createsend1.com/static/eb/master/05-slate/images/btn.png);
...
.one-col-feature blockquote {
    background-image: url(https://i4.createsend1.com/static/eb/master/05-slate/images/blockquote.png);
...
@media only screen and (max-width: 620px) {
    ...
    [class=wrapper] .one-col-feature .column-top {
        font-size: 62px !important;
        line-height: 62px !important;
    }

    [class=wrapper] .one-col-feature .column-bottom {
    ...
    [class=wrapper] .one-col-feature blockquote:after {
        display: none;
    }
}
...
@media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
    [class=wrapper] .one-col-feature blockquote {
        background-image: url(https://i7.createsend1.com/static/eb/master/05-slate/images/blockquote@2x.png) !important;
        background-size: 28px 26px !important;
    }

    [class=wrapper] .footer .twitter {
        background-image: url(https://i5.createsend1.com/static/eb/master/05-slate/images/twitter@2x.gif) !important;
        background-size: 150px 43px;
    }

    [class=wrapper] .footer .facebook {
        background-image: url(https://i6.createsend1.com/static/eb/master/05-slate/images/facebook@2x.gif) !important;
        background-size: 150px 43px;
    }
...
<meta content="Welcome to TaxiDeals &ndash; Order #<?php echo $invoice_id; ?>" property="og:title">
<link type="text/css" rel="stylesheet" media="screen,projection"
      href="https://css.createsend1.com/css/social.min.css?h=A3DB20FCmercury">
...
.wrapper, .preheader, .header, .one-col-bg, .emb-editor-canvas {
    background-color: #f6f9fb
}
...
.one-col p, .one-col ol, .one-col ul, .one-col-feature p, .one-col-feature ol, .one-col-feature ul {
    line-height: 25px;
    Margin-bottom: 25px;
    font-weight: 400
}
...
@media only screen and (min-width: 0) {
    .wrapper .logo div {
        font-family: Cabin, Avenir, sans-serif !important
    }
}
...
.wrapper .btn a {
    ...
    box-shadow: 0 2px 0 #20925a;
    color: #fff;
    text-shadow: 0 1px 0 0 1px 0 #23a263
}

.wrapper .btn a:hover {
    color: #fff !important;
    background-color: #3ad488 !important;
    box-shadow: 0 2px 0 #29bc73 !important
}
...
blockquote
p, blockquote ol, blockquote ul {
}

.wrapper blockquote p, .wrapper blockquote ol, .wrapper blockquote ul {
}
...
.one-col blockquote p, .one-col blockquote ol, .one-col blockquote ul, .one-col-feature blockquote p, .one-col-feature blockquote ol, .one-col-feature blockquote ul {
    line-height: 26px
}

.two-col blockquote p, .two-col blockquote ol, .two-col blockquote ul {
    line-height: 24px;
    font-weight: 300
}

.three-col blockquote p, .three-col blockquote ol, .three-col blockquote ul {
    font-weight: 300;
    line-height: 21px
}
...
.one-col-feature .shadow {
    background-color: #c4cfd7
}

.preheader td, .preheader p {
    color: #b3b3b3
}

.wrapper .preheader td, .wrapper .preheader p {
}
...
.preheader td a, .preheader p a {
    font-weight: 700
}

.wrapper .preheader a, .wrapper .footer
a {
    color: #b3b3b3
}

.wrapper .preheader a:hover, .wrapper .footer a:hover {
...
.wrapper .footer .left, .wrapper .footer .right, .wrapper .footer p {
}
...
.footer .left a, .footer .right a, .footer p a {
    font-weight: 700
}
...
h2.form-signin-heading {
    background: #333938 url("http://taxideals.com.au/dev/application/views/img/taxideals_logo_admin.png") no-repeat scroll center center;
...
<center
    style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f6f9fb"
    class="wrapper">
    <table style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #f6f9fb" class="header">
        <tbody>
        <tr>
            <td style="padding: 0;vertical-align: top">&nbsp;</td>
            <td style="padding: 0;vertical-align: top;mso-line-height-rule: at-least;padding-top: 16px;padding-bottom: 32px;width: 600px"
                class="logo">
    ...
    <table style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #f6f9fb" class="one-col-bg">
        <tbody>
        <tr>
                ...
                <table
                    ...
                    <tr>
                        <td style="padding: 0;vertical-align: top;text-align: left" class="column">
                            <div>
                                <div style="font-size: 52px;line-height: 52px" class="column-top">&nbsp;</div>
                            </div>
                            <table style="border-collapse: collapse;border-spacing: 0;width: 100%" class="contents">
                                ...
                                <tr>
                                    <td style="padding: 0;vertical-align: top;padding-left: 90px;padding-right: 90px"
                                        ...
                                        <h1 style="Margin-top: 0;color: #2e3b4e;font-size: 36px;Margin-bottom: 24px;font-family: Tahoma,sans-serif;text-align: center;line-height: 44px">
                                            Welcome to TaxiDeals</h1>
                                        ...
                                        <p style="Margin-top: 0;color: #4e5561;font-size: 16px;font-family: sans-serif;line-height: 25px;Margin-bottom: 25px;font-weight: 400">
                                            Hi <?php echo $first_name . ' ' . $last_name; ?>,<br>Thank you for &nbsp;purchasing
                                            a TaxiDeals <strong style="font-weight: bold"><?php echo $plan; ?></strong>&nbsp;subscription.
                                        </p>

                                        <p style="Margin-top: 0;color: #4e5561;font-size: 16px;font-family: sans-serif;line-height: 25px;Margin-bottom: 25px;font-weight: 400">
                                            We want to support you in your efforts and value feedback. Please do not
                                            hesitate to reach out to us, whatever the need.</p>

                                        <p style="Margin-top: 0;color: #4e5561;font-size: 16px;font-family: sans-serif;line-height: 25px;Margin-bottom: 25px;font-weight: 400">
                                            This email is confirming that we received payment for order <b>#<?php echo $invoice_id; ?></b>. The invoice is attached as a PDF for your records.
                                        </p>
                                        <p style="Margin-top: 0;color: #4e5561;font-size: 16px;font-family: sans-serif;line-height: 25px;Margin-bottom: 26px;font-weight: 400">
                                            Log in to your TaxiDeals account now using your email address
                                            [<?php echo $user_email; ?>] to make any modifications to your account, or
                                            to start creating:<br>
                                            <a href="https://server.taxideals.com.au/"
                                               style="text-decoration: underline;transition: all 0.2s;color: #27b46e"
                                               target="_blank">https://server.taxideals.com.au/</a></p>
                            ...
                            <div style="font-size: 26px;line-height: 26px" class="column-bottom">&nbsp;</div>
                        </td>
                    </tr>
                    </tbody>
                </table>
